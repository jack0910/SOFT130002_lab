...
function prev() {
    for (let i = 0; i < 5; i++) {
        document.getElementById('span' + number).classList.remove('on');
    }
    if (number === 0) {
        number = 4;
    } else {
    ...
    document.getElementById('span' + number).classList.add('on');
}
